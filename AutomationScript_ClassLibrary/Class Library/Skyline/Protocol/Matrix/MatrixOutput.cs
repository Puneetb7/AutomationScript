namespace Skyline.DataMiner.Library.Protocol.Matrix
{
	...
	public class MatrixOutput : MatrixPort
	{
		...
		public override string Page
		{
			get
			{
				if (PortState.OutputPages != null)
					return PortState.OutputPages[Index];
				else
					return String.Empty;
			}
			...
			{
				if (PortState.OutputPages != null)
					PortState.OutputPages[Index] = value;
			}
		}
		...
		public string ToolTip
		{
			get
			{
				if (PortState.ToolTips != null)
					return PortState.ToolTips[Index];
				else
					return String.Empty;
			}
			...
			{
				if (PortState.ToolTips != null)
					PortState.ToolTips[Index] = value;
			}
		}
